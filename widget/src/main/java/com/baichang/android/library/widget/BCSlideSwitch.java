...
public class BCSlideSwitch extends View {
	...
	public BCSlideSwitch(Context context, AttributeSet attrs, int defStyleAttr) {
	...
	public BCSlideSwitch(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public BCSlideSwitch(Context context) {
		this(context, null);
	}
