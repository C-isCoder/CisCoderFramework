...
public class InteractionContentAdapter extends Adapter<ViewHolder> {
    ...
    class ViewHolder extends RecyclerView.ViewHolder
        ...
        ViewHolder(View itemView) {
            ...
            ivVideo =
                    (ImageView) itemView.findViewById(R.id.item_interaction_content_photo_iv_video);
            ivPlay =
                    (ImageView) itemView.findViewById(R.id.item_interaction_content_photo_btn_play);
