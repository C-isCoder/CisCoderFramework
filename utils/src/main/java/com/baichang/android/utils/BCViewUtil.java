...
public class BCViewUtil {
    ...
    public static int scale(Context context, float value) {
        DisplayMetrics mDisplayMetrics = BCDensityUtil.getDisplayMetrics(context);
    ...
    public static int scale(int displayWidth, int displayHeight, float pxValue) {
        float scale = 1;
        try {
            float scaleWidth = (float) displayWidth / BCAppConfig.uiWidth;
            float scaleHeight = (float) displayHeight / BCAppConfig.uiHeight;
