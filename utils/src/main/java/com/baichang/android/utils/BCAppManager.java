 ...
 * @created 2012-3-21
 */
public class BCAppManager {
    private static final String TAG_INTENT_DATA = "Data";
    private static Stack<Activity> activityStack;
    private static BCAppManager instance;

    private BCAppManager() {
    }

    /**
     * 单一实例
     */
    public static BCAppManager getAppManager() {
        if (instance == null) {
            instance = new BCAppManager();
        }
        return instance;
    }
    ...
    public static void startActivity2(Activity act, Class cls, Object obj, int requestCode) {
        ...
        intent.setClass(act, cls);
        if (obj != null) {
            intent.putExtra(TAG_INTENT_DATA, (Serializable) obj);
        }
