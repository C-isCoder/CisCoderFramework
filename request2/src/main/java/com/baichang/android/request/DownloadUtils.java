...
public class DownloadUtils {
  ...
  public static void down(Context context, Observable<ResponseBody> observable,
      HttpSuccessListener<File> listener) {
  ...
  public static void down(Context context, String fileName, Observable<ResponseBody> observable,
      HttpSuccessListener<File> listener) {
    WeakReference<Context> wc = new WeakReference<Context>(context);
    sContext = wc.get();
    sSuccessListener = listener;
  ...
  public static File writeResponseBodyToFile(ResponseBody body, String fileName) {
    ...
    try {
      ...
      ApplicationInfo applicationInfo =
          packageManager.getApplicationInfo(sContext.getPackageName(), 0);
  ...
  public static String getCurrentTime() {
    ...
    str = str + c.get(Calendar.YEAR) + "-" + (c.get(Calendar.MONTH) + 1) + "-" + c.get(
        Calendar.DAY_OF_MONTH) + " " + +c.get(Calendar.HOUR_OF_DAY) + ":" + c.get(Calendar.MINUTE);
    return str;
  }
