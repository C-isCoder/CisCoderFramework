package com.baichang.android.circle.widget.photocontents;
...
import com.baichang.android.circle.widget.photocontents.logic.CommonLogic;
import com.baichang.android.circle.widget.photocontents.logic.ConfigDefinition;
import com.baichang.android.circle.widget.photocontents.logic.LineDefinition;
import com.baichang.android.circle.widget.photocontents.logic.ViewDefinition;
...
public class FlowLayoutManager extends RecyclerView.LayoutManager {
  ...
  public void onLayoutChildren(RecyclerView.Recycler recycler, RecyclerView.State state) {
    ...
    int realControlLength = CommonLogic
        .findSize(this.config.getLengthMode(), this.config.getMaxLength(), contentLength);
    int realControlThickness = CommonLogic
        .findSize(this.config.getThicknessMode(), this.config.getMaxThickness(), contentThickness);
  ...
  public static class LayoutParams extends RecyclerView.LayoutParams {
    ...
    private void readStyleParameters(Context context, AttributeSet attributeSet) {
      ...
      try {
        ...
        this.gravity = a.getInt(R.styleable.FlowLayout_LayoutParams_android_layout_gravity,
            Gravity.NO_GRAVITY);
