...
public class InteractionContentFragment extends InteractionCommonFragment
    ...
    @Override public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        rvList.addItemDecoration(new VerticalDividerDecoration(
                ContextCompat.getColor(getContext(), R.color.interaction_layout_background)));
    ...
    @Override public void gotoDetail(InteractionListData data) {
    ...
    @Override public void gotoInfo(boolean isOneself, String userId) {
