package com.baichang.android.printer.gpsdk;
...
public class DeviceConnFactoryManager {
    ...
    private static DeviceConnFactoryManager[] deviceConnFactoryManagers =
            new DeviceConnFactoryManager[4];
    ...
    public static final class Build {
        ...
        private int port;
        private CONN_METHOD connMethod = CONN_METHOD.BLUETOOTH; // 默认蓝牙连接
        ...
        ThreadPool.getInstantiation().addTask(new Runnable() {
            @Override public void run() {
                ...
                final ScheduledExecutorService scheduledExecutorService =
                        new ScheduledThreadPoolExecutor(1, threadFactoryBuilder);
    ...
    private static final String printer_state = "状态：";
                    ...
                    if (sendCommand == esc) {
                        ...
                        if (currentPrinterCommand == null) {
                            ...
                            if (result == 0) {//打印机状态查询
                                ...
                                System.out.println(printer_state + status);
