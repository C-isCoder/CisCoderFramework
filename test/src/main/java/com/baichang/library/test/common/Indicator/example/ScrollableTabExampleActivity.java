...
import com.baichang.android.widget.magicIndicator.buildins.commonnavigator.indicators.BezierPagerIndicator;
import com.baichang.android.widget.magicIndicator.buildins.commonnavigator.indicators.LinePagerIndicator;
import com.baichang.android.widget.magicIndicator.buildins.commonnavigator.indicators.TriangularPagerIndicator;
import com.baichang.android.widget.magicIndicator.buildins.commonnavigator.indicators.WrapPagerIndicator;
...
import com.baichang.library.test.common.Indicator.ext.titles.ColorFlipPagerTitleView;
import com.baichang.library.test.common.Indicator.ext.titles.ScaleTransitionPagerTitleView;

import java.util.Arrays;
import java.util.List;

public class ScrollableTabExampleActivity extends CommonActivity {
