...
import com.baichang.android.library.widget.dialog.LoadingDialog;
...
public class MLDialogUtils {
    ...
    public static AlertDialog getDialog(final Context context, String title, String content, DialogInterface.OnClickListener sureListener, DialogInterface.OnClickListener cancelListener, DialogInterface.OnDismissListener dismissListener) {
