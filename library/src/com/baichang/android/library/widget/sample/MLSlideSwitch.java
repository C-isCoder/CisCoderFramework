...
public class MLSlideSwitch extends View {
	...
	public MLSlideSwitch(Context context, AttributeSet attrs, int defStyleAttr) {
	...
	public MLSlideSwitch(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public MLSlideSwitch(Context context) {
		this(context, null);
	}
