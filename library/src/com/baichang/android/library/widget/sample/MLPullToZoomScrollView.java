 ...
 */
public class MLPullToZoomScrollView extends ScrollView {
    private static final String TAG = MLPullToZoomScrollView.class.getSimpleName();
    ...
    public MLPullToZoomScrollView(Context context) {
        this(context, null);
    }

    public MLPullToZoomScrollView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MLPullToZoomScrollView(Context context, AttributeSet attrs, int defStyle) {
